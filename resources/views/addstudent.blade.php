                ...
                <div class="col col-8 p-4 my-2" style="background:black; border-radius: 3rem 0 3rem 0;">
                    ...
                    <table class="table text-white my-1">
                        @foreach ($collection as $item)
                            ...
                            <td class="d-flex flex-column justify-content-center w-75" >
                                <p>{{$item->fname}}</p>
                            ...
                            @endfor -->
                            <td>
                                <a href="assignstudent/{{$item->registration}}/{{$teachername}}" class="d-flex flex-row align-items-center justify-content-center menu-items my-3">
                                    <img src="{{asset('/imgs/logos/add.svg')}}" alt="">Add</a>
                            </td>
                            </tr>
                        @endforeach
                    </table>
