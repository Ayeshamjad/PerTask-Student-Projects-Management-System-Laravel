            ...
            >
              <form action="signup" method="POST" enctype="multipart/form-data">
                ...
                @if (session('name_email'))
                              <div class="alert alert-danger error-message text-center" style="padding:0;background: transparent; font-size:0.8rem; margin-bottom:0.5rem; margin-top:0.7rem; border:none; color:rgb(237, 73, 86)">
                              {{ session('name_email') }}</div>
                @endif
